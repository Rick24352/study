...
"set guifont=Monaco:h18	"设置字体为Monaco，大小10
...
set guifont=Courier_New:h13:cANSI   " 设置字体 Courier_New 
...
"2018-8-24 10:20更新
"设置 gvim 字体
"set guifont=华文中宋:h15
set guifont=Courier_New:h15:cANSI   " 设置字体 Courier_New
...
func HeaderPython()  
	""HeaderPython函数内部，但配置不正确call setline(1,"#!/usr/bin/env python")
